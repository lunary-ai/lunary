...
create index dataset_v2_item_dataset_id_input_idx
    on dataset_v2_item using gin (dataset_id, input gin_trgm_ops);

create index dataset_v2_item_dataset_id_expected_output_idx
    on dataset_v2_item using gin (dataset_id, expected_output gin_trgm_ops);
