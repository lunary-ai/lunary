...
export const Span: MessageFns<Span> = {
  ...
  fromJSON(object: any): Span {
    return {
      ...
      endTimeUnixNano: isSet(object.endTimeUnixNano) ? BigInt(object.endTimeUnixNano) : 0n,
  ...
  fromPartial<I extends Exact<DeepPartial<Span>, I>>(object: I): Span {
    ...
    message.endTimeUnixNano = object.endTimeUnixNano ?? 0n;
...
function createBaseSpan_Event(): Span_Event {
  return { timeUnixNano: 0n, name: "", attributes: [], droppedAttributesCount: 0 };
}
