...
export default function DynamicChart({
  ...
  const { splitBy: initialSplitBy, groupBy: initialGroupBy } = chartConfig;

  const [splitBy, setSplitBy] = useState(initialSplitBy);
  ...
  // Update parent component with new config when splitBy or groupBy changes
  useEffect(() => {
    onUpdateConfig({ splitBy, groupBy });
  }, [splitBy, groupBy]);
