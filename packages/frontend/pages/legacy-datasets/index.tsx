...
import { useDataset, useDatasets, useUser, useOrg } from "@/utils/dataHooks";
  ...
  return (
    <Card p="lg" withBorder pos="relative" style={{ overflow: "visible" }}>
      ...
      <Group justify="space-between">
        ...
        <Button
          onClick={() => Router.push(`/legacy-datasets/${typedDataset.id}`)}
          size="sm"
...
export default function Datasets() {
  ...
  function createDataset(format) {
    insert(
      ...
      {
        onSuccess: (dataset) => {
          Router.push(`/legacy-datasets/${dataset.id}`);
        },
      },
    );
  }
